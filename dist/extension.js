...
exports.validateFileType = exports.createTheTestFile = exports.isTestFileExist = exports.generateTestFileName = exports.getFileContent = exports.createTestFolder = void 0;
...
const getFileContent = (activeTextEditor) => {
    return activeTextEditor.document.getText();
};
exports.getFileContent = getFileContent;
const generateTestFileName = (activeTextEditor) => {
    const filePath = activeTextEditor.document.uri.fsPath;
...
const isTestFileExist = (filePath) => {
...
const vscode = __webpack_require__(1);
const generateMessage = (message, type = 'info') => {
    if (type === 'warning')
...
// @ts-ignore
const common_1 = __webpack_require__(58);
// @ts-ignore
...
axios.VERSION = (__webpack_require__(51).version);
...
var transitionalDefaults = __webpack_require__(21);
...
const packageJson = __webpack_require__(61);
class Configuration {
    constructor(param = {}) {
        ...
        if (!this.formDataCtor) {
            this.formDataCtor = __webpack_require__(62);
        }
    }
    /**
...
var CombinedStream = __webpack_require__(63);
var util = __webpack_require__(46);
var path = __webpack_require__(5);
var http = __webpack_require__(33);
var https = __webpack_require__(34);
var parseUrl = (__webpack_require__(36).parse);
...
var util = __webpack_require__(46);
var Stream = (__webpack_require__(37).Stream);
var DelayedStream = __webpack_require__(64);
        ...
        if (activeTextEditor) {
            if ((0, helpers_1.validateFileType)(activeTextEditor)) {
                if (!(0, helpers_1.isTestFileExist)((0, helpers_1.generateTestFileName)(activeTextEditor))) {
                    ...
                    (0, messages_1.generateMessage)("Test file already exist!", 'error');
                }
            }
            else {
